...
namespace event_manager {
    ...
    class EventManager {
    public:
        using EventSubscriberMap = std::unordered_map<std::type_index, std::vector<EventListenerBase*>>;
        ...
        /**
            ...
            */
        template<typename TEvent>
        bool SubscriptionExists(EventListener<TEvent>* listener) const {
    ...
    private:
        // Marked as nodiscard as return value should be used to determine weather to
        // add/remove/get key-value pair
        [[nodiscard]]
